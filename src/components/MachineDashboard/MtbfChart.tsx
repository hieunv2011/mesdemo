    ...
    chart: {
      ...
      events: {
        render(this: Highcharts.Chart) {
          ...
          const x =
            chart.plotLeft + series.center[0] - customLabel.getBBox().width / 2;
          const y =
            chart.plotTop + series.center[1] - customLabel.getBBox().height / 2;
  ...
  return (
    <>
      <p style={{ textAlign: "center", fontWeight: "bold" }}>
        Thời gian dự kiến máy lỗi (MTBF)
      </p>
